        ...
        if conversacion_activa is None and not conversation_id_proporcionado:
            ...
            if nueva_conversacion and nueva_conversacion.get("id"):
                ...
                if codigo_crm:
                    ...
                    if nombre_programa:
                        self._agregar_nota_conversacion(conversation_id, f"Programa - {nombre_programa}: {codigo_crm}")
                    else:
            ...
            if codigo_crm:
                nombre_programa = self._obtener_nombre_programa(codigo_crm)
                if nombre_programa:
                    self._agregar_nota_conversacion(conversation_id, f"NuevoPrograma - {nombre_programa}: {codigo_crm}")
                else:
